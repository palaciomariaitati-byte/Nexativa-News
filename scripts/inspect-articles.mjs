...
async function inspectArticles() {
  ...
  if (error) {
    ...
    console.log("Sample article columns:", articles ? Object.keys(articles[0] || {}) : "none");
    articles?.forEach(a => console.log("Article:", a.title, "| category:", a.category, "| created_at:", a.created_at));
  }
}
